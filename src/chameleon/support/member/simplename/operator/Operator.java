 ...
 */
public abstract class Operator<E extends Operator<E,H,S,M>, H extends DeclarationWithParametersHeader<H,S>, S extends DeclarationWithParametersSignature, M extends Method> extends RegularMethod<E,H,S,M> {
